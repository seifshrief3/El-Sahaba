          ...
          <div className="h-[76px] flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                disabled={refreshing}
                className="h-10 px-3 md:px-4 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-600 flex items-center gap-2 text-xs font-bold transition"
              >
                <RefreshCw
                  size={16}
              ...
              <button
                ...
                className="h-10 px-3 md:px-4 rounded-xl border border-red-200 bg-white hover:bg-red-50 text-red-600 flex items-center gap-2 text-xs font-bold transition"
              >
                <LogOut size={16} />
